...
class HZMetro(Dataset):
    def __init__(self, cfgs, split):
        ...
        if split == 'train':
            ...
            graph_conn = get_k_hop_metrix(graph_conn, 1e6)

            graphs = {'graph_conn': graph_conn, 'graph_sml_dtw': graph_sml_dtw, 'graph_cor': graph_cor}
